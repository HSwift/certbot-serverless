/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 25b30af13b91a77dfdda8ecff055a435)
// Runtime types generated with workerd@1.20260903.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	CERTIFICATES: R2Bucket;
	DB: D1Database;
	ACME_DIRECTORY_URL: "https://acme-v02.api.letsencrypt.org/directory";
	DOWNLOAD_URL_BASE: "https://api.example.com";
	ACCESS_TEAM_DOMAIN: "https://your-team.cloudflareaccess.com";
	ACCESS_AUD: "replace-with-access-application-aud";
	CLOUDFLARE_API_TOKEN: string;
	API_BEARER_TOKEN: string;
	DOWNLOAD_SIGNING_KEY: string;
	CERTIFICATE_MASTER_KEY: string;
	ACME_ACCOUNT_KEY: string;
	CERTIFICATE_WORKFLOW: Workflow<Parameters<import("./src/index").CertificateWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACME_DIRECTORY_URL" | "DOWNLOAD_URL_BASE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "CLOUDFLARE_API_TOKEN" | "API_BEARER_TOKEN" | "DOWNLOAD_SIGNING_KEY" | "CERTIFICATE_MASTER_KEY" | "ACME_ACCOUNT_KEY">> {}
}
